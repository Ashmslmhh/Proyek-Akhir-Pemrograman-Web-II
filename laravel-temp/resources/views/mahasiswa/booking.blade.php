    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card-custom">
                <form action="/mahasiswa/booking" method="POST">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="sesi_waktu" class="form-select" required>
                                ...
                                <option value="09:00 - 10:30 WIB">Sesi 1 (09:00 - 10:30 WIB)</option>
                                <option value="10:30 - 12:00 WIB">Sesi 2 (10:30 - 12:00 WIB)</option>
                                <option value="13:30 - 15:00 WIB">Sesi 3 (13:30 - 15:00 WIB)</option>
                                <option value="15:30 - 17:00 WIB">Sesi 4 (15:30 - 17:00 WIB)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="topik" class="form-control" placeholder="Contoh: Diskusi Bab III atau Revisi Diagram UML" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold small text-muted">Deskripsi Tambahan / Pertanyaan Spesifik</label>
                        <textarea name="catatan" class="form-control" rows="5" placeholder="Tulis rincian kendala yang ingin Anda konsultasikan agar dosen dapat mempelajari terlebih dahulu..." required></textarea>
                    </div>
